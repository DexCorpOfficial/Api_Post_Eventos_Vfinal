...
namespace Api_Post_Eventos_Vfinal.Controllers
{
    public class ComentarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,contenido,fecha,activo")] Comentario comentario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,contenido,fecha,activo")] Comentario comentario)
        {
            if (id != comentario.ID)
            {
                return NotFound();
